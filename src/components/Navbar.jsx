...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-20 min-h-10 mx-auto p-3 flex px-sm md:px-md lg:px-lg justify-between items-center flex-wrap md:flex-nowrap transition-all duration-300 bg-white shadow-md">
      <NavLink to="/" className="flex justify-center items-center mx-2 mr-auto">
        <img src={logo} alt="Logo" className="w-28 object-contain" />
      </NavLink>

      <div className={`${!menu ? "hidden" : "absolute top-10 left-0 right-0 bg-white flex flex-col px-4"} lg:flex lg:flex-row lg:static lg:bg-transparent lg:items-center lg:gap-4 my-3 mx-auto gap-2 font-bold text-sm order-1 w-full lg:w-max lg:order-0`}>
      <NavLink to="#"
