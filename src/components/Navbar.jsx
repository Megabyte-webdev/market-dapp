...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-20 mx-auto px-3 flex px-sm md:px-md lg:px-lg justify-between items-center flex-wrap md:flex-nowrap transition-all duration-300 bg-white shadow-md">
      ...
      <div className={`${!menu ? "hidden" : "absolute min-h-8 top-28 left-0 right-0 bg-white flex flex-col gap-2"} lg:flex lg:flex-row lg:static lg:bg-transparent lg:items-center lg:gap-4 mx-auto gap-2 font-bold text-sm order-1 w-full lg:w-max lg:order-0`}>
      <NavLink to="#"
