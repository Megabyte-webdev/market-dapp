...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-20 min-h-8 mx-auto p-3 flex px-sm md:px-md lg:px-lg justify-between items-center flex-wrap md:flex-nowrap transition-all duration-300 bg-white shadow-md">
